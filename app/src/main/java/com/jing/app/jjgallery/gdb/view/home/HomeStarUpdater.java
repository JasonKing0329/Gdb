...
import com.jing.app.jjgallery.gdb.view.pub.cardslider.CardSliderLayoutManager;
import com.jing.app.jjgallery.gdb.view.pub.cardslider.DefaultViewUpdater;

public class HomeStarUpdater extends DefaultViewUpdater {

    public HomeStarUpdater(CardSliderLayoutManager lm) {
        super(lm);
    }
