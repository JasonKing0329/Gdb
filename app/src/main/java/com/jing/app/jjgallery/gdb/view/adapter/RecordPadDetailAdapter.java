 ...
 */
public class RecordPadDetailAdapter extends RecyclerView.Adapter<RecordPadDetailHolder> {
    ...
    @Override
    public RecordPadDetailHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_gdb_record_pad_detail, parent, false);
        return new RecordPadDetailHolder(view);
    }

    @Override
    public void onBindViewHolder(RecordPadDetailHolder holder, int position) {
