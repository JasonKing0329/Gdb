...
public class RecordPageStarDetailAdapter extends RecyclerView.Adapter<RecordPageStarDetailAdapter.StarHolder> implements View.OnClickListener {
    ...
    public RecordPageStarDetailAdapter() {
        starOptions = GlideUtil.getStarOptions();
    }

    @Override
    public StarHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new StarHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_record_page_pad_star_detail, parent, false));
    }
