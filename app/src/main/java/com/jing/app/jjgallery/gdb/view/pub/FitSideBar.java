...
public class FitSideBar extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            mTextSize = a.getDimensionPixelSize(R.styleable.FitSideBar_indexTextSize, ScreenUtils.dp2px(14));
            mTextColor = a.getColor(R.styleable.FitSideBar_indexTextColor, Color.parseColor("#3F51B5"));
            mTextSizeFocus = a.getDimensionPixelSize(R.styleable.FitSideBar_indexTextSizeFocus, ScreenUtils.dp2px(16));
            mTextColorFocus = a.getColor(R.styleable.FitSideBar_indexTextColorFocus, Color.parseColor("#FF4081"));
